...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { restaurant_id: @wishlist.restaurant_id, user_id: @wishlist.user_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { restaurant_id: @wishlist.restaurant_id, user_id: @wishlist.user_id } }
